...
export default function TotalQuestions() {
  return (
    <div className="col-span-1 order-1 md:col-span-8 lg:col-span-2 border shadow-sm p-2 gap-2 flex justify-center items-center flex-col bg-white rounded-xl md:rounded-3xl">
